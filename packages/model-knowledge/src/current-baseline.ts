...
import { DEEPSEEK_CURRENT_RECORDS, withCurrentDeepSeekV4CatalogEvidence } from './deepseek-current.ts'
...
export const BASELINE_KNOWLEDGE_BUNDLE = {
  ...
  generatedAt,
  records: [
    ...LEGACY_BASELINE_KNOWLEDGE_BUNDLE.records.map(withCurrentDeepSeekV4CatalogEvidence),
